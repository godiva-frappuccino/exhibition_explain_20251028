  ...
  return (  
    <div className="App">  
        ...
        <div className="App-text">  
          ...
          <div className="App-paragraph">  
            <p>  
              ...
              私が夢に見た姿をスケッチしたのが、以下のイラストです。その体から露出する機械は時計仕掛けになっており、  
              ゼンマイがテンプの往復運動と連結されることで等速でほどけ、それに紐づいたカムが身体の各部に繋がれているイメージを想起しました。  
            </p>  
          ...
          <div className="App-paragraph">  
            <p>  
              作品内部は時計仕掛けの仕組みになっており、ゼンマイを巻くことで、時計と同様にゼンマイがほどけながら  
              宙に吊られた右手の指が反復運動を行います。  
            </p>  
      ...
      <footer className="App-footer">  
        <h4>展示概要</h4>  
        <p>期間: 2024年10月28日 - 2024年11月19日</p>  
